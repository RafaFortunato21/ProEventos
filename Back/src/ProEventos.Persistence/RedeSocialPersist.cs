...
namespace ProEventos.Persistence
{
    public class RedeSocialPersist : GeralPersist, IRedeSocialPersist
    {
        ...
        public async Task<RedeSocial> GetRedeSocialEventoByIdsSync(int eventoId, int id)
        {
            IQueryable<RedeSocial> query = _context.RedesSociais;
        ...
        public async Task<RedeSocial> GetRedeSocialPalestranteByIdsSync(int palestranteId, int id)
        {
            IQueryable<RedeSocial> query = _context.RedesSociais;
